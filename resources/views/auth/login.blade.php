        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
            <div class="w-full max-w-md space-y-8">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div class="form-control">
                            <label class="label cursor-pointer">
                                <input type="checkbox" id="remember_me" name="remember"
                                    class="checkbox checkbox-primary checkbox-sm mr-2 outline-none focus:outline-none focus-visible:outline-none ring-0 focus:ring-0 focus-visible:ring-0 ring-offset-0 focus:ring-offset-0 focus:shadow-none" />
                    ...
                    <!-- Login Button -->
                    <button type="submit"
                        class="btn btn-primary w-full text-white font-semibold py-3 text-base bg-gray-800 hover:bg-gray-900 border-none outline-none focus:outline-none focus-visible:outline-none ring-0 focus:ring-0 focus-visible:ring-0 ring-offset-0 focus:ring-offset-0 focus:shadow-none">
                        Login
                    </button>
                    ...
                    <button type="button"
                        class="btn btn-outline w-full outline-none focus:outline-none focus-visible:outline-none ring-0 focus:ring-0 focus-visible:ring-0 ring-offset-0 focus:ring-offset-0 focus:shadow-none">
