    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-cover bg-center bg-no-repeat relative" 
            ...
            <div class="relative z-10 flex flex-col justify-center items-start p-12 text-white max-w-lg">
                <div class="mb-8">
                    <h1 class="text-4xl font-bold mb-4 leading-tight">Comienza tu viaje de aprendizaje hoy</h1>
                    <p class="text-xl text-white/90 leading-relaxed">Únete a miles de estudiantes que ya están transformando su futuro con nuestra plataforma educativa.</p>
                </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
            <div class="w-full max-w-md space-y-8">
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600">Completa el formulario para comenzar</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <!-- Register Button -->
                    <button type="submit" class="btn btn-primary w-full text-white font-semibold py-3 text-base bg-gray-800 hover:bg-gray-900 border-none">
                        Crear Cuenta
                    </button>
