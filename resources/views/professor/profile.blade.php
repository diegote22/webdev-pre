        ...
        <div class="bg-base-100 border-b border-base-300">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-base-content">Perfil del Profesor</h1>
                        <p class="text-base-content/70 mt-2">Gestiona tu información personal, reseña profesional y
                            configuración de cuenta</p>
                    </div>
                    <!-- Navigation Links -->
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('professor.profile') }}" class="btn btn-primary btn-sm">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <a href="{{ route('courses.index') }}" class="btn btn-outline btn-sm">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="card bg-base-100 shadow-xl mb-8">
                <div class="card-body">
                    <div class="mb-6">
                        ...
                        <p class="text-base-content/70">Actualiza tu información personal y reseña profesional</p>
                    </div>

                    <form method="POST" action="{{ route('professor.profile.update') }}" class="space-y-6"
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div class="form-control">
                                ...
                                <input type="text" name="first_name"
                                    ...
                                    class="input input-bordered focus:input-primary" placeholder="Ej: Dr. Juan Carlos"
                                    required />
                                @error('first_name')
                                    <label class="label">
                            ...
                            <div class="form-control">
                                ...
                                <input type="text" name="last_name"
                                    ...
                                    class="input input-bordered focus:input-primary" placeholder="Ej: González Martínez"
                                    required />
                                @error('last_name')
                                    <label class="label">
                                        <span class="label-text-alt text-error">{{ $message }}</span>
                        ...
                        <div class="form-control">
                            ...
                            <input type="email" name="email" value="{{ old('email', $user->email) }}"
                                ...
                                placeholder="Ej: profesor@universidad.edu" required />
                            @error('email')
                                <label class="label">
                                    <span class="label-text-alt text-error">{{ $message }}</span>
                                </label>
                        ...
                        <div class="form-control">
                            <label class="label">
                                <span class="label-text font-semibold">Reseña Profesional</span>
                                <span class="label-text-alt text-sm">Descripción de tu experiencia y
                                    especialización</span>
                            </label>
                            <textarea name="biography" class="textarea textarea-bordered h-40 focus:textarea-primary resize-none"
                                placeholder="Escribe sobre tu experiencia profesional, formación académica, áreas de especialización, metodología de enseñanza, logros destacados, etc. Esta información será visible para los estudiantes en tu perfil público.">{{ old('biography', $user->biography ?? '') }}</textarea>
                            <div class="label">
                                <span class="label-text-alt text-xs">Máximo 1000 caracteres</span>
                            </div>
                            @error('biography')
                                <label class="label">
                                    <span class="label-text-alt text-error">{{ $message }}</span>
            ...
            <div class="card bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('professor.profile.password') }}" class="space-y-6">
                        @csrf
                        @method('patch')
