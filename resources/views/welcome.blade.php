    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
        <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center space-x-6">
                ...
                <a href="#pre-universitario" class="text-gray-600 hover:text-blue-600 transition duration-300">Pre-Universitario</a>
                <a href="#universitario" class="text-gray-600 hover:text-blue-600 transition duration-300">Universitario</a>
            ...
            <div class="flex items-center space-x-3">
                <a href="/login" class="px-5 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition duration-300">Iniciar Sesión</a>
                <a href="/register" class="px-5 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition duration-300">Registrarse</a>
            </div>
        </nav>
    </header>
    ...
    <main>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div class="text-center md:text-left">
                    ...
                    <p class="mt-6 text-lg text-gray-600">
                        Cursos diseñados por expertos para potenciar tu aprendizaje en cada etapa de tu formación. Prepárate para el éxito.
                    </p>
                    <div class="mt-8 flex justify-center md:justify-start gap-4">
                        <a href="#cursos" class="px-8 py-3 font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition duration-300">Explorar Cursos</a>
                        <a href="#nosotros" class="px-8 py-3 font-semibold text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 transition duration-300">Saber Más</a>
                    </div>
                </div>
                <div class="bg-gray-200 rounded-lg shadow-lg h-64 md:h-96 flex items-center justify-center">
                    ...
                    <video class="w-full h-full object-cover rounded-lg" controls poster="https://placehold.co/600x400/e2e8f0/334155?text=Video+Promocional">
            ...
            <div x-data="carousel()">
                <div class="flex justify-between items-end mb-8">
                    ...
                    <div class="hidden md:flex items-center gap-2">
                        <button @click="prev()" class="w-10 h-10 flex items-center justify-center bg-white rounded-full shadow-md hover:bg-gray-100 transition">‹</button>
                        <button @click="next()" class="w-10 h-10 flex items-center justify-center bg-white rounded-full shadow-md hover:bg-gray-100 transition">›</button>
                    </div>
                </div>
                <div class="relative">
                    <div x-ref="slider" class="flex overflow-x-auto snap-x snap-mandatory scroll-smooth" style="-ms-overflow-style: none; scrollbar-width: none;">
                        <!-- Ejemplo de 5 Cursos -->
                        <div class="flex-shrink-0 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-3 snap-start">
                            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                                <img src="https://placehold.co/400x250/3b82f6/ffffff?text=Matemática+3er+Año" alt="Curso" class="w-full h-48 object-cover">
                                <div class="p-5">
                        ...
                        <div class="flex-shrink-0 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-3 snap-start">
                            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                                <img src="https://placehold.co/400x250/10b981/ffffff?text=Biología+Celular" alt="Curso" class="w-full h-48 object-cover">
                                <div class="p-5">
                        ...
                        <div class="flex-shrink-0 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-3 snap-start">
                           <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                                <img src="https://placehold.co/400x250/f97316/ffffff?text=Física+General" alt="Curso" class="w-full h-48 object-cover">
                                <div class="p-5">
                        ...
                        <div class="flex-shrink-0 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-3 snap-start">
                             <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                                <img src="https://placehold.co/400x250/8b5cf6/ffffff?text=Química+Orgánica" alt="Curso" class="w-full h-48 object-cover">
                                <div class="p-5">
                        ...
                        <div class="flex-shrink-0 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-3 snap-start">
                             <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                                <img src="https://placehold.co/400x250/ec4899/ffffff?text=Historia+Argentina" alt="Curso" class="w-full h-48 object-cover">
                                <div class="p-5">
                ...
                <div class="text-center mt-10">
                    <a href="/cursos/secundaria" class="px-8 py-3 font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition duration-300">Ver los cursos Secundarios</a>
                </div>
            </div>
        ...
        <section id="nosotros" class="container mx-auto px-6 py-16">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 mt-2 max-w-2xl mx-auto">Combinamos tecnología, pedagogía y la experiencia de los mejores profesores para ofrecerte una experiencia de aprendizaje única.</p>
            </div>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="grid gap-4">
                    <div>
                        <img class="h-auto max-w-full rounded-lg shadow-md" src="https://placehold.co/500x700/a5b4fc/312e81?text=Estudiante+Concentrado" alt="">
                    </div>
                     <div>
                        <img class="h-auto max-w-full rounded-lg shadow-md" src="https://placehold.co/500x500/818cf8/1e1b4b?text=Clase+Virtual" alt="">
                    </div>
                </div>
                <div class="grid gap-4">
                    <div>
                        <img class="h-auto max-w-full rounded-lg shadow-md" src="https://placehold.co/500x500/6366f1/eef2ff?text=Material+de+Estudio" alt="">
                    </div>
                    <div>
                        <img class="h-auto max-w-full rounded-lg shadow-md" src="https://placehold.co/500x700/4f46e5/e0e7ff?text=Profesor+Explicando" alt="">
                    </div>
                </div>
                <div class="grid gap-4">
                    <div>
                        <img class="h-auto max-w-full rounded-lg shadow-md" src="https://placehold.co/500x700/6d28d9/f5f3ff?text=Trabajo+en+Equipo" alt="">
                    </div>
                     <div>
                        <img class="h-auto max-w-full rounded-lg shadow-md" src="https://placehold.co/500x500/7c3aed/f5f3ff?text=Éxito+Académico" alt="">
                    </div>
                </div>
                 <div class="grid gap-4">
                    <div>
                        <img class="h-auto max-w-full rounded-lg shadow-md" src="https://placehold.co/500x500/9333ea/faf5ff?text=Plataforma+Intuitiva" alt="">
                    </div>
                    <div>
                        <img class="h-auto max-w-full rounded-lg shadow-md" src="https://placehold.co/500x700/a855f7/faf5ff?text=Graduación" alt="">
                    </div>
                </div>
            </div>
        </section>
